        ...
        <div class="center">
          <div class="inline-block">
            <div class="input-group">
              ...
              <input  class="input-text" id="username" type="text" v-model="userModel.username" name="username" />
            </div>
            <div class="input-group">
              <label class="input-label" for="password">密码：</label>
              <input class="input-text" id="password" type="password" v-model="userModel.password" name="password" />
            </div>
            <div class="input-group">
              <a href="#" class="button color small round no-margin" @click="login">Login</a>
              <input class="check-box"  type="checkbox" name="remember" v-model="userModel.remeberMe" value="true">Remember Me
            </div>
          </div>
...
<script>
  ...
  import userService from "../../ajax/userService.js"
    ...
    export default {
        ...
        methods:{
          login:function(){
            ...
            userService.doLogin(userModel.username, userModel.password, function(ret){
                alert(ret.message);
            })
          }
        },
        data(){
          var userModel = {username: "", password: "", remeberMe:false};
          return {
            userModel: userModel
          }
        }
